	...
	<div class = "card"  >
		<header class="entry-header text-center ">
			...
			<div class = "card-body" >
				...
				<h3 class="post-title-2 mt-5 mb-5 text-center"><a href = "<?php the_permalink(); ?>" title = "<?php the_title_attribute(); ?>" ><?php the_title(); ?></a></h3>
               
                <div class="excerpt ml-3 mr-3"><?php the_excerpt(); ?> </div>

				<p class=" shadow read-more theme-hover pl-2 pr-2"> <a href="<?php the_permalink(); ?>"><?php echo esc_html( get_theme_mod('creative_business_blog_read_more_title',__('READ MORE', 'creative-business-blog'))); ?></a></p>
