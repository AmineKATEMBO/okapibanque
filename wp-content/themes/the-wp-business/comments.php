...
<div id="comments" class="comments-area">
		...
		<h2 class="comments-title">
			<?php
				...
				if ( 1 === $comments_number ) {
					...
					printf( esc_html__( 'One thought on &ldquo;%s&rdquo;', 'the-wp-business' ), esc_html(get_the_title()) );
				} 	else {
					printf(
	...
	?>
		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'the-wp-business' ); ?></p>
	<?php endif; ?>
