...
<article class="postbox smallpostimage">
  ...
  <div class="row">
    ...
    <div class="col-lg-10 col-md-10 ">
      ...
      <a href="<?php echo esc_url( get_permalink() );?>" class="blogbutton-small hvr-sweep-to-right"><?php esc_html_e('Read Full','the-wp-business'); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('the_wp_business_blog_button_text',__('Read Full', 'the-wp-business')) ); ?></span></a>
    </div>
    <div class="clearfix"></div>
  </div>
</article>