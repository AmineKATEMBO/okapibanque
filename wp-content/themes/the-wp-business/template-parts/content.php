...
<article class="postbox smallpostimage">
  ...
  <div class="row">
    <?php if(get_theme_mod('the_wp_business_metafields_date',true)){ ?>
    ...
    <div class="col-lg-10 col-md-10 ">
      ...
      <?php }?>
      <div class="metabox">
        <?php if(get_theme_mod('the_wp_business_metafields_author',true)){ ?>
        ...
        <?php }?>
        <?php if(get_theme_mod('the_wp_business_metafields_comment',true)){ ?>
