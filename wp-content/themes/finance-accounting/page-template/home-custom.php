...
<main role="main" id="main">
  ...
  <?php if( get_theme_mod('finance_accounting_section_title') != '' || get_theme_mod('finance_accounting_section_text') != '' || get_theme_mod('finance_accounting_blogcategory_setting') != ''){ ?>
    <section id="services">
      <div class="container">
        <h2><?php echo esc_html(get_theme_mod('finance_accounting_section_title','')); ?></h2>
        <p class="service-title"><?php echo esc_html(get_theme_mod('finance_accounting_section_text','')); ?></p>
        <div class="row">
          <?php 
