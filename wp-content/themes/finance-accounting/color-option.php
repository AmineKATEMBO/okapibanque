...
.main-navigation li li:hover > a,.main-navigation ul ul li a,.logo h1 a,.site-title, .site-title a, .blogger.singlebox .category a:hover,#sidebox ul li a:hover,.post-info a:hover, #services h3 a{';
	...
	$finance_accounting_stickyheader = get_theme_mod( 'finance_accounting_enable_disable_fixed_header',false);
	if($finance_accounting_stickyheader == true && get_theme_mod( 'finance_accounting_fixed_header', false) == false){
    	$finance_accounting_custom_css .='.fixed-header{';
			$finance_accounting_custom_css .='position:static;';
		$finance_accounting_custom_css .='} ';
	}
    if($finance_accounting_stickyheader == true){
    	$finance_accounting_custom_css .='@media screen and (max-width:575px) {';
		$finance_accounting_custom_css .='.fixed-header{';
			$finance_accounting_custom_css .='position:fixed;';
		$finance_accounting_custom_css .='} }';
	}else if($finance_accounting_stickyheader == false){
		$finance_accounting_custom_css .='@media screen and (max-width:575px) {';
		$finance_accounting_custom_css .='.fixed-header{';
			$finance_accounting_custom_css .='position:static;';
		$finance_accounting_custom_css .='} }';
	...
	$finance_accounting_custom_css .='.site-info{';
		$finance_accounting_custom_css .='font-size: '.esc_html($finance_accounting_footer_text_font_size).'px;';
	$finance_accounting_custom_css .='}';
	...
	$finance_accounting_custom_css .='#comments textarea{';
		$finance_accounting_custom_css .='width: '.esc_html($finance_accounting_comment_form_size).'%;';
	$finance_accounting_custom_css .='}';
	...
	$finance_accounting_custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled]{';
		$finance_accounting_custom_css .='padding-top: '.esc_html($finance_accounting_shop_button_padding_top).'px; padding-bottom: '.esc_html($finance_accounting_shop_button_padding_top).'px;';
	$finance_accounting_custom_css .='}';

	$finance_accounting_shop_button_padding_left = get_theme_mod('finance_accounting_shop_button_padding_left', 16);
	$finance_accounting_custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled]{';
		$finance_accounting_custom_css .='padding-left: '.esc_html($finance_accounting_shop_button_padding_left).'px; padding-right: '.esc_html($finance_accounting_shop_button_padding_left).'px;';
	$finance_accounting_custom_css .='}';
	...
	$finance_accounting_custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt{';
		$finance_accounting_custom_css .='border-radius: '.esc_html($finance_accounting_shop_button_border_radius).'px;';
	$finance_accounting_custom_css .='}';
	...
	$finance_accounting_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
		$finance_accounting_custom_css .='padding-top: '.esc_html($finance_accounting_shop_page_top_padding).'px !important; padding-bottom: '.esc_html($finance_accounting_shop_page_top_padding).'px !important;';
	$finance_accounting_custom_css .='}';

	$finance_accounting_shop_page_left_padding = get_theme_mod('finance_accounting_shop_page_left_padding',10);
	$finance_accounting_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
		$finance_accounting_custom_css .='padding-left: '.esc_html($finance_accounting_shop_page_left_padding).'px !important; padding-right: '.esc_html($finance_accounting_shop_page_left_padding).'px !important;';
	$finance_accounting_custom_css .='}';

	$finance_accounting_shop_page_border_radius = get_theme_mod('finance_accounting_shop_page_border_radius',0);
	$finance_accounting_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
		$finance_accounting_custom_css .='border-radius: '.esc_html($finance_accounting_shop_page_border_radius).'px;';
	$finance_accounting_custom_css .='}';

	$finance_accounting_shop_page_box_shadow = get_theme_mod('finance_accounting_shop_page_box_shadow',0);
	$finance_accounting_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
		$finance_accounting_custom_css .='box-shadow: '.esc_html($finance_accounting_shop_page_box_shadow).'px '.esc_html($finance_accounting_shop_page_box_shadow).'px '.esc_html($finance_accounting_shop_page_box_shadow).'px #e4e4e4;';
	$finance_accounting_custom_css .='}';
