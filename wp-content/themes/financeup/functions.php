 ...
 */
	...
	require( $financeup_theme_path . '/customize/class-alpha-color-control/class-alpha-color-control.php');
	require_once( trailingslashit( get_template_directory() ) . 'inc/ansar/customize/customize-pro/class-customize.php' );

// Theme version.
$financeup_theme = wp_get_theme();
define( 'FINANCEUP_THEME_VERSION', $financeup_theme->get( 'Version' ) );
define ( 'FINANCEUP_THEME_NAME', $financeup_theme->get( 'Name' ) );
